soap4flash aims to make really easy to request SOAP webservices from Flash with a flex like mechanism.

In order to download please checkout the sources directly
